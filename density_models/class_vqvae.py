...
import wandb, sys
from density_models import CondVQVAELearner
...
flags.DEFINE_float('made_lr_decay', 5e-4, 'MADE learning rate exponential decay (per epoch).')
...
coder = CondVQVAELearner(input_size=784,
                         input_shape=(28, 28, 1), 
                         cond_size=10,
                         output_size=784,
